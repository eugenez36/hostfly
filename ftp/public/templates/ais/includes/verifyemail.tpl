        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-1">
                    <button id="btnResendVerificationEmail" class="btn btn-default btn-sm btn-block" data-lang-conf="{$LANG.emailSent}">
                    {$LANG.resendEmail}
                </button>
                </div>
            </div>
    ...
    <div class="email-verification">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-1">
                    <button id="btnResendVerificationEmail" class="btn btn-default btn-sm btn-block btn-resend-verify-email" data-lang-conf="{$LANG.emailSent}">
                        {$LANG.resendEmail}
                    </button>
                </div>
            </div>
