...
<form method="post" action="{$smarty.server.PHP_SELF}?step=3" enctype="multipart/form-data" role="form">
    ...
    <div class="row">
        <div class="form-group col-sm-4">
            ...
            <input type="text" name="name" id="inputName" value="{if $loggedin}{if $clientname|count_characters>0}{$clientname}{else}{$clientsdetails.companyname}{/if}{else}{$name}{/if}" class="form-control{if $loggedin} disabled{/if}"{if $loggedin} disabled="disabled"{/if} />
        </div>
