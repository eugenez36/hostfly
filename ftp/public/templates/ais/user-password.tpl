    ...
    <div class="card-body">
        ...
        <form class="using-password-strength" method="post" action="{routePath('user-password')}" role="form">
            ...
            <div class="form-group row">
                <label for="inputExistingPassword" class="col-lg-4 col-form-label">{lang key='existingpassword'}</label>
                <div class="col-lg-5">
            ...
            <div id="newPassword1" class="form-group has-feedback row">
                <label for="inputNewPassword1" class="col-lg-4 col-form-label">{lang key='newpassword'}</label>
                <div class="col-lg-5">
            ...
            <div id="newPassword2" class="form-group has-feedback row">
                <label for="inputNewPassword2" class="col-lg-4 col-form-label">{lang key='confirmnewpassword'}</label>
                <div class="col-lg-5">
